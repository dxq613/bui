...
define('bui/uploader/button/htmlButton', function(require) {
    ...
    BUI.extend(Button, Base, /** @lends Button.prototype*/{
        ...
        _createInput : function() {
            ...
            _self.set('inputContainer', inputContainer);
            //禁用按钮
            _self._setDisabled(self.get('disabled'));
            //控制多选
            _self._setMultiple(self.get('multiple'));
        ...
        _setDisabled : function(disabled){
            var _self = this,
                cls = _self.get('cls'),disabledCls = cls.disabled,
                $target = _self.get('target'),
