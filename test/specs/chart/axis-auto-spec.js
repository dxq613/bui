	...
	describe('计算简单集合',function(){
		...
		it('指定最小值',function(){
			var data = [
				...
				rst = Auto.caculate({data : data,min : -2500,interval : 2500});
			log(data,rst);
		...
		it('测试整数',function(){
			var data =[ [0, 1, 4, 4, 5, 2, 3, 7],[1, 0, 3, 0, 3, 1, 2, 1]],
				rst = Auto.caculate({data : data});
			log(data,rst);
		...
		it('更多测试1',function(){
			var data = [[49.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4],
