...
define('bui/grid/grid',['bui/common','bui/mask','bui/toolbar','bui/list','bui/grid/header','bui/grid/column'],function (require) {
  ...
  var grid = List.SimpleList.extend({
    ...
    ATTRS : {
       ...
       * <ol>
       * <li>items:工具栏的项，
       * 可以是按钮(bar-item-button)、
       * 文本(bar-item-text)、
       * 链接(bar-item-link)、
       * 分隔符(bar-item-separator)以及自定义项
       * </li>
       * <li>pageSize:表明包含分页栏</li>
       * </ol>
...
define('bui/grid/plugins',['bui/common',BASE + 'cascade',BASE + 'cellediting',BASE + 'rowediting',BASE + 'dialogediting',BASE + 'menu',BASE + 'summary'],function (r) {
